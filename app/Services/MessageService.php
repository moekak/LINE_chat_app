...
class MessageService{
    ...
    public function getMergedData($admin_id, $mergedData){
        ...
        foreach($mergedData as $data){
            ...
            $latest_message_createdAt = $latest_message->created_at ?? null;

            $data["latest_message"] = ($latest_message_createdAt && $latest_message_createdAt >= $user_createdAt )?  $this->retrieveLatestMessage($data->id, $admin_id) : "";
